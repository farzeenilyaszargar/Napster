  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="mx-auto flex w-full max-w-4xl flex-1 flex-col px-6 py-16 md:px-10">
        <p className="text-sm uppercase tracking-[0.28em] text-[#ababab]">Install</p>
        <h1 className="font-pixelify text-6xl text-[#232323]">Get Napster Running</h1>
        ...
        <div className="mt-10 rounded-3xl border border-black/8 bg-[#fbfbfb] p-6 shadow-[0_20px_80px_rgba(0,0,0,0.08)] backdrop-blur-sm">
          <p className="text-sm uppercase tracking-[0.24em] text-[#ababab]">Command</p>
          <code className="mt-3 block rounded-2xl border border-black/8 bg-white px-4 py-4 text-base text-[#232323] shadow-[0_10px_30px_rgba(0,0,0,0.04)]">
            npm -i napster
          </code>
          <p className="mt-6 text-sm uppercase tracking-[0.24em] text-[#ababab]">Next</p>
          <code className="mt-3 block rounded-2xl border border-black/8 bg-white px-4 py-4 text-base text-[#232323] shadow-[0_10px_30px_rgba(0,0,0,0.04)]">
            npm run dev
          </code>
        </div>
